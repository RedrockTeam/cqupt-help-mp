...
export const changPassword = ({ Origin, New }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/password/personal",
    {
...
export const sentEmailMessage = (email) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/bind/email/code",
    {
...
export const bindEmail = ({ emailAddress, userCode }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/bind/email",
    {
...
export const bindProtect = ({ id, value }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/bind/question",
    {
      // https://run.mocky.io/v3/6517388e-1f46-4a69-9307-79837f41d6a1
      method: "POST",
      header: {
...
export const getQuestionList = (_key: string) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/question",
    {
...
export const checkEmail = (account) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/valid/email/code",
    {
      // https://run.mocky.io/v3/c320935a-1150-4320-b0be-2e59196e1491
      method: "POST",
      header: {
...
export const checkEmailCode = ({ email, code, account }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/valid/email",
    {
...
export const getEmail = (account) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/bind/email/detail",
    {
      method: "POST",
      header: {
        "Content-Type": "application/x-www-form-urlencoded",
...
export const changeNewPassword = ({ account, new_password, code }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/password/valid",
    {
      method: "POST",
      header: {
        "Content-Type": "application/x-www-form-urlencoded",
...
export const getProtectQuestion = (account) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/bind/question/detail",
    {
...
export const checkAnswer = ({ stu_num, question_id, content }) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/valid/question",
    {
      // https://run.mocky.io/v3/4d229f07-43a8-4b3e-928a-e233864a6e3e
      method: "POST",
      header: {
...
export const judgePassword = (password) =>
  request<getQuestionLists>(
    "https://be-prod.redrock.cqupt.edu.cn/user-secret/christina/user/judge/password",
    {
      method: "POST",
      header: {
        "Content-Type": "application/x-www-form-urlencoded",
